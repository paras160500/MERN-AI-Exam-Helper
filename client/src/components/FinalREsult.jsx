...
function FinalREsult({ result }) {
  ...
  return (
    <div className="mt-6 p-3 spacd-y-10 bg-white">
      ...
      {quickRevision && (
        <section className="rounded-xl bg-linear-to-r from-green-100 to-green-50 border border-green-200 p-6 mt-10">
          <h3 className="font-bold text-green-700 mg-3 text-xl">
            ⚡ Exam Quick Revision Points
          </h3>
          <ul className="list-disc ml-6 space-y-1 text-gray-800 mt-3">
